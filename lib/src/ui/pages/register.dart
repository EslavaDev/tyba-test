...
class _RegisterState extends State<Register> with ValidationMixins {
                      ...
                      child: RaisedButton(
                        ...
                        onPressed: () {
                          if (_formKey.currentState.validate()) {
                            ...
                            try {
                              provider.signUp(_email, _password);
                            } catch (e) {
                              Toast.show(
                                  'Es posible que este usuario ya exista o la contraseña sea menor a 6 digitos',
                                  context);
                            }
                          } else {
                            // validation error
